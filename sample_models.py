...
def cnn_rnn_model(
    input_dim, filters, kernel_size, conv_stride, conv_border_mode, units, output_dim=29
):
    """Build a recurrent + convolution network for speech"""
    # Main acoustic input
    input_data = Input(name="the_input", shape=(None, input_dim))
...
def final_model(input_dim, filters=200, kernel_size=11, conv_stride=2, conv_border_mode='valid', units=200, output_dim=29,):
